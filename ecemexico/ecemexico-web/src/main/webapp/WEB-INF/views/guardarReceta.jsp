...
<div class="container">
      ...
      <div class="well lead">
		<a href="mostrarRecetas?idPaciente=<c:out value='${idPaciente}'/>" class='btn btn-block btn-primary btn-default'>Recetas Médicas</a> 
		</div>
		<div class="well lead">Generar Receta Médica  (*)Campos obligatorios</div>
		 ...
		 <form:errors path = "*" cssClass = "errorblock" element = "div" />
			...
			<div class="row">
				<div class="form-group col-md-7">
					<label class="col-md-3 control-lable" for="nombreDoctor">Médico</label>
					<div class="col-md-7">
...
' <label class="col-md-3 control-lable" for="duracion'+counter+'">Duración'+counter+
